...
public class ArrayKatas {
    ...
    public static int[] fiveRandomInts() {
        ...
        int[] fiveRandomInts = new int[]{random.nextInt(), random.nextInt(), random.nextInt(), random.nextInt(), random.nextInt()};
    ...
    public static LocalDate[] threeArbitraryDates() {
        ...
        threeArbitraryDates[0] = LocalDate.of(2006, 12, 12);
        threeArbitraryDates[1] = LocalDate.of(2012, 06, 04);
        threeArbitraryDates[2] = LocalDate.of(2016, 01, 01);
